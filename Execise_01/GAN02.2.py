...
class DCGAN():
    ...
    def train(self, sample_dir, GperD_steps=1, ckpt_dir='ckpt', training_epochs = 1000000, batch_size = 32, output_size=10000):
        ...
        for epoch in range(training_epochs):
            ...
            if (epoch % output_size == 0) or (epoch == 1):
...
if __name__ == '__main__':
    ...
    data = ISIC_data('./training_images_160x160', 160)

	# run
    dcgan = DCGAN(generator, discriminator, data)
    dcgan.train(sample_dir, training_epochs=epochs, output_size=epochs/10, batch_size=5)
